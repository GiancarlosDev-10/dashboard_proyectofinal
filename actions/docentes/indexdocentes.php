    ...
    <div id="content">
        ...
        <div class="container mt-4">
            ...
            <?php if (isset($_GET['add']) && $_GET['add'] === 'ok'): ?>
                <div class="alert alert-success alert-dismissible fade show">Docente agregado correctamente.
                    <button type="button" class="close" data-dismiss="alert">&times;</button>
                </div>
            <?php endif; ?>

            <?php if (isset($_GET['edit']) && $_GET['edit'] === 'ok'): ?>
                <div class="alert alert-success alert-dismissible fade show">Docente actualizado correctamente.
                    <button type="button" class="close" data-dismiss="alert">&times;</button>
                </div>
            <?php endif; ?>

            <?php if (isset($_GET['delete']) && $_GET['delete'] === 'ok'): ?>
                <div class="alert alert-success alert-dismissible fade show">Docente eliminado correctamente.
                    <button type="button" class="close" data-dismiss="alert">&times;</button>
                </div>
            <?php endif; ?>

            <?php if (isset($_GET['error'])): ?>
                <div class="alert alert-danger alert-dismissible fade show"><?= htmlspecialchars($_GET['error']) ?>
                    <button type="button" class="close" data-dismiss="alert">&times;</button>
                </div>
            <?php endif; ?>
            ...
            $result = $conn->query("SELECT * FROM docente ORDER BY id DESC LIMIT $inicio, $registros");
            ?>
                    ...
                    <?php while ($row = $result->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="/admin_php/actions/docentes/deletedocentes.php?id=<?= $row['id'] ?>"
...
<div class="modal fade" id="addModal" tabindex="-1">
    <div class="modal-dialog">
        <form action="adddocentes.php" method="POST" class="modal-content">
...
<div class="modal fade" id="editModal" tabindex="-1">
    <div class="modal-dialog">
        <form action="editardocentes.php" method="POST" class="modal-content">

            <div class="modal-header bg-warning">
                <h5 class="modal-title text-white">Editar Docente</h5>
                <button type="button" class="close" data-dismiss="modal"><span>&times;</span></button>
            </div>
...
<script>
    ...
    document.getElementById('busqueda').addEventListener('input', function() {
        ...
        filas.forEach(fila => {
            fila.style.display = fila.textContent.toLowerCase().includes(f) ? "" : "none";
        });
    });
